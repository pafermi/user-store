...
export class CreatePoliticDto {
    ...
    static create(object: {[key:string]:any}) : [string?,CreatePoliticDto?] {
        ...
        return [undefined,new CreatePoliticDto( nombre, apellido, edad, rol, partido_politico, sueldo, fecha_ingreso, rol_previo, comentarios)]
    }
